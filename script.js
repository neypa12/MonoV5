...
let currentAction = { type: null, targetId: null, targetName: null };
// Para manejo de acciones
...
// =========================================================
    ...
    function startAppListeners() {
        ...
        db.collection("transactions").onSnapshot((snapshot) => {
            ...
            // Clonar e invertir el array para que la más reciente sea la primera en el bucle.
            const reversedDocs = [...snapshot.docs].reverse(); 

            reversedDocs.forEach((doc, index) => {
                // Calcular el número de operación (descendente: N, N-1, ..., 1)
                const operationNumber = totalTransactions - index; 
